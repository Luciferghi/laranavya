  ...
  <div class="wrap_header">
    ...
    <div class="wrap_menu">
      <nav class="menu">
        <ul class="main_menu">
          ...
          <li>
            <a href="{{ route('Shop.featured') }}">Features</a>
          </li>
    ...
    <div class="header-icons">
      ...
      <ul>
        <li id="login">
          @if(!Auth::check())
          <a id="login-trigger" href=" {{ route('login') }}">
            Log in <span></span>
          </a>
        ...
        @else
        <li id="login">
          <form id="login" action="{{ route('logout') }}" method="POST">
                                        @csrf
      ...
      <div class="header-wrapicon2">
        ...
        <div class="header-cart header-dropdown">
          <ul class="header-cart-wrapitem">
            @foreach (Cart::getContent() as $product)
              ...
              <div class="header-cart-item-img">
                <img src="{{ productImage($product->attributes->image) }}" alt="IMG">
              </div>
          ...
          <div class="header-cart-buttons">
            ...
            <div class="header-cart-wrapbtn">
              <!-- Button -->
              <a href="{{-- {{ route('') }} --}}" class="flex-c-m size1 bg1 bo-rad-20 hov1 s-text1 trans-0-4">
                Check Out
              </a>
            </div>
          </div>
